...
geoshow([2 2 -22 -22 2],[240 272 272 240 240],'DisplayType','Line','color','k','linewidth',1.5);
% geoshow(data(:,2),data(:,1),'DisplayType','line','Color','black','LineWidth',1);
% geoshow([-14 -14 17 17 -14],[28.5 51.5 51.5 28.5 28.5],'DisplayType','Line','color','r','linewidth',2);
