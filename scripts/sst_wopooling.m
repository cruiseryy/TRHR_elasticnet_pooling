...
% % minMSE lambda = 37/28 for real amplitude predictand 
% % minMSE lambda = 21/16/12 for binary predictand
% pause = 1;
% 
%----------------------------------------------
...
for lag = 0:24
    ...
    [Beta, FitInfo] = lasso(xx(1:20,:), trhr_prcp(1:20,:), 'Lambda',37 , 'Alpha', 0.01);
